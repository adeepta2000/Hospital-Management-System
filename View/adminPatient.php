...
<head>
    ...
    <title>Admin-Patient_List</title>
...
<div>
    ...
    <a href="adminAddpatient.php"><button class="submit">Add Patient</button></a>
...
{    
    ...
    <td>
    <a href='../controller/patientDelete.php?id=$Id'><button>Delete</button></a>
    </td>
    </tr>
